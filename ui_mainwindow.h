...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        tabWidget->setStyleSheet(QString::fromUtf8("QTabBar::tab { height: 80\n"
...
" }"));
        ...
        pCO2DisplayButton->setGeometry(QRect(240, 50, 200, 130));
        pCO2DisplayButton->setStyleSheet(QString::fromUtf8(""));
        label_2 = new QLabel(general);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(240, 30, 200, 20));
        ...
        pHDisplayButton_2->setGeometry(QRect(450, 230, 200, 130));
        pHDisplayButton_2->setStyleSheet(QString::fromUtf8(""));
        label_12 = new QLabel(general);
        label_12->setObjectName(QString::fromUtf8("label_12"));
        label_12->setGeometry(QRect(450, 210, 200, 20));
...
"font-size: 30;"));
        ...
        sizePolicy.setHeightForWidth(set_f1_button->sizePolicy().hasHeightForWidth());
        set_f1_button->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(set_m_button->sizePolicy().hasHeightForWidth());
        set_m_button->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(set_dPhi1_button->sizePolicy().hasHeightForWidth());
        set_dPhi1_button->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(set_dPhi2_button->sizePolicy().hasHeightForWidth());
        set_dPhi2_button->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(set_dKSV1_button->sizePolicy().hasHeightForWidth());
        set_dKSV1_button->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(set_dKSV2_button->sizePolicy().hasHeightForWidth());
        set_dKSV2_button->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(set_A1_button->sizePolicy().hasHeightForWidth());
        set_A1_button->setSizePolicy(sizePolicy);
        ...
        sizePolicy1.setHeightForWidth(set_A2_button->sizePolicy().hasHeightForWidth());
        set_A2_button->setSizePolicy(sizePolicy1);
        ...
        sizePolicy.setHeightForWidth(set_x0_button->sizePolicy().hasHeightForWidth());
        set_x0_button->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(set_dx_button->sizePolicy().hasHeightForWidth());
        set_dx_button->setSizePolicy(sizePolicy);
        ...
        sizePolicy.setHeightForWidth(set_temp_co2_button->sizePolicy().hasHeightForWidth());
        set_temp_co2_button->setSizePolicy(sizePolicy);
        ...
        sizePolicy2.setHeightForWidth(set_lmin_button->sizePolicy().hasHeightForWidth());
        set_lmin_button->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(set_lmax_button->sizePolicy().hasHeightForWidth());
        set_lmax_button->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(set_pH0_button->sizePolicy().hasHeightForWidth());
        set_pH0_button->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(set_dpH_button->sizePolicy().hasHeightForWidth());
        set_dpH_button->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(set_temp_button->sizePolicy().hasHeightForWidth());
        set_temp_button->setSizePolicy(sizePolicy2);
